defmodule CyasgWeb.Router do
  use CyasgWeb, :router

  import CyasgWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CyasgWeb.Layouts, :root}
  ...
  # scope "/api", CyasgWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:cyasg, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CyasgWeb.Telemetry
  ...
  scope "/", CyasgWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CyasgWeb.UserAuth, :redirect_if_user_is_authenticated}],
      layout: false do
  ...
  scope "/", CyasgWeb do
    ...
    live_session :current_user,
      on_mount: [{CyasgWeb.UserAuth, :mount_current_user}] do
